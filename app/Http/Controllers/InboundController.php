...
class InboundController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $wharehouse = Inbound::where('nama', $request->wharehouse_id)->first();
        if($wharehouse){
            $empData = [
            'nama' => $wharehouse->nama,
        ...
        $pe = [
            'volume' => $wharehouse->volume + $request->volume
        ];

        $wharehouse = Inbound::where('id', $wharehouse->id)->update($pe);
        ...
        if(asset($wharehouse) == 0){
            $pentol = Wharehouse::where('id', $request->wharehouse_id)->first();
            $empData = [
            'nama' => $pentol->id,
            'tanggal' => $request->tanggal,
            'jenis_barang' => $request->jenis_barang,
